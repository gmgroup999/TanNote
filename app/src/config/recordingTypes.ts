...
export const RECORDING_TYPES: Record<RecordingTypeKey, RecordingType> = {
  ...
  appointment: { label: '📅 นัดหมาย',           description: 'บันทึกการนัดหมาย กำหนดการ หรือ event ต่างๆ AI สกัดวันเวลา สถานที่ ผู้เข้าร่วม และตั้งการแจ้งเตือนให้อัตโนมัติผ่าน LINE',  summaryFocus: 'วัน/เวลา/สถานที่, ผู้เข้าร่วม, แจ้งเตือนอัตโนมัติ' },
...
export const RECORDING_TYPE_ORDER: RecordingTypeKey[] = [
  'auto', 'meeting', 'appointment', 'sales', 'idea', 'lecture', 'interview', 'diary', 'general',
];
