...
import { LIFF_ENABLED } from '../lib/liff';
...
export default function LoginPage() {
  ...
  function handleLineLogin() {
    try { liff.login(); } catch { /* liff not ready — shouldn't happen */ }
  }
            ...
            <div className="flex flex-col gap-5">
              ...
              {LIFF_ENABLED && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 py-3 rounded-xl bg-[#06C755] hover:bg-[#05b34c] text-white text-sm font-semibold transition-colors"
                >
